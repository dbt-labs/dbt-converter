...
conversation_parts as (
    ...
    select * from ANALYTICS.dbt_jstein.base__intercom_conversation_parts
...
md5(cast(coalesce(cast(ticket_id as TEXT), '') || '-' || coalesce(cast(ticket_comment_number as TEXT), '') as TEXT)) 
