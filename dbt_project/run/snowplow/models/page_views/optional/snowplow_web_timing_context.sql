        ...
        create or replace transient table analytics_dev.dbt_jstein.snowplow_web_timing_context  as
        (


with  __dbt__cte__snowplow_base_performance_timing_context as (


select * from analytics_dev.dbt_jstein.current_snowplow_performance_timing
),performance_timing_context as (

    select * from __dbt__cte__snowplow_base_performance_timing_context
