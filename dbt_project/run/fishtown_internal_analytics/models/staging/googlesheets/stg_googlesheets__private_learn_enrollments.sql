  ...
  create or replace   view analytics_dev.dbt_jstein.stg_googlesheets__private_learn_enrollments
...
source as (
    ...
    select * from raw.fivetran_googlesheets.training_private_learners
