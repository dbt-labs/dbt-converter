  ...
  create or replace   view analytics_dev.dbt_jstein.stg_accredible__credentials
...
md5(cast(coalesce(cast(recipient_email as TEXT), '') || '-' || coalesce(cast(developer_credential_number as TEXT), '') as TEXT))
