        ...
        create or replace transient table analytics_dev.dbt_jstein.fct_cloud_accounts  as
        (
...
invocations as (
    ...
    select * from analytics_dev.dbt_jstein.fct_dbt_invocations
...
repos as (
    ...
    select * from analytics_dev.dbt_jstein.stg_cloud__repos

),

jobs as (

    select * from analytics_dev.dbt_jstein.dim_cloud_jobs

),

versions as (

    select * from analytics_dev.dbt_jstein.dim_dbt_versions
...
feature_flags as (
    ...
    select * from analytics_dev.dbt_jstein.stg_cloud__account_feature_flags
...
cloud_metrics as (
    ...
    select * from analytics_dev.dbt_jstein.fct_cloud_run_metrics
...
metadata_usage as (
    ...
    select * from analytics_dev.dbt_jstein.metadata_account_usage
...
adapters as (
    ...
    select * from analytics_dev.dbt_jstein.fct_cloud_project_connections
...
semantic_layer_environments as (
    ...
    select * from analytics_dev.dbt_jstein.dim_cloud_semantic_layers

),

semantic_layer_queries as (

    select * from analytics_dev.dbt_jstein.fct_semantic_layer_queries
...
service_tokens as (
    ...
    select * from analytics_dev.dbt_jstein.stg_cloud__service_token
