        ...
        create or replace transient table analytics_dev.dbt_jstein.int_snowplow_sessions  as
        (
...
snowplow_sessions as (
    ...
    select * from analytics_dev.dbt_jstein.int_snowplow_sessions_tmp

),

id_map as (

    select * from analytics_dev.dbt_jstein.snowplow_id_mappings
...
stitched as (
    ...
    left join id_map
        on snowplow_sessions.user_snowplow_domain_id = id_map.domain_userid
