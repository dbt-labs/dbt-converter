        ...
        create or replace transient table analytics_dev.dbt_jstein.int_cloud_account_mappings__stepped  as
        (with

account_domains_ranked as (

    select * from analytics_dev.dbt_jstein.int_account_domains__ranked
...
step_1 as (
    ...
    left join single_tenant_rankings
        on account_domains_ranked.database_source = single_tenant_rankings.database_source
