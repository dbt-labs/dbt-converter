...
renamed as (
    ...
    select
        ...
        ---------- booleans
        id in {{ internal_sfdc_accounts_list() }} as is_internal_account,
        ...
        fortune_500__c as is_fortune500,
        global_500__c as is_global500,
        america_s_largest_private__c as is_americas_largest_private,
        ...
        ---------- account tiering fields
        account_hierarchy_type__c as account_hierarchy_type,
        customer_tier__c as customer_tier,
        customer_tier_override__c as overridden_customer_tier,
        current_arr_hierarchy__c as hierarchy_current_arr,
        current_arr_sd__c as sd_hierarchy_current_arr,
