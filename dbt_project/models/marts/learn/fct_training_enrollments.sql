...
all_enrollments as (
    ...
    select * from {{ ref('int__training_enrollments_unioned') }}
...
mapping_percent_chapter as (
    ...
    from {{ ref('stg_seed__training_mapping_percent_chapter') }}
...
calc_last_completed_chapter as (
    ...
    left join mapping_percent_chapter
        ...
        and all_enrollments.created_at >= mapping_percent_chapter.valid_from
        and all_enrollments.created_at < mapping_percent_chapter.valid_to
...
final as (
    ...
    select
        ...
        calc_percentage_of_chapter.created_at,
