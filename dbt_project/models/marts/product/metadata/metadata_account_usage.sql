...
metadata_daily_user_activity as (
    ...
    select * from {{ ref('metadata_daily_user_activity') }}
...
metadata_account_summary as (
    ...
    select
        ...
        sum(total_internal_metadata_api_requests) as total_internal_metadata_api_requests,
        min(
            case 
...
final as (
    ...
    select
        *,
        ...
        case when total_internal_metadata_api_requests > 0 then 1 else 0 end as has_internal_metadata_api_requests,
