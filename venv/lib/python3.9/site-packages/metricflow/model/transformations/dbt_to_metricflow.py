...
class DbtManifestTransformer:
    ...
    def _build_dimension(self, name: str, dbt_metric: DbtMetric) -> Dimension:
        ...
        print(name)
        print(self.time_dimension_stats.keys())
    ...
    def build_dimensions(self, dbt_metric: DbtMetric) -> List[Dimension]:
        ...
        print(f'BUILD DIMS: \n{dbt_metric.dimensions}\n')
        print(f'{dbt_metric.name}\n')
    ...
    def collect_time_dimension_stats(cls, dbt_metrics: List[DbtMetric]) -> Dict[str, List[str]]:
        ...
        for dbt_metric in dbt_metrics:
            if dbt_metric.calculation_method != "derived" and dbt_metric.model is not None and dbt_metric.timestamp is not None:
                # print(dbt_metric.model)
                # print(dbt_metric.timestamp)
                # # print(time_stats_for_metric_models.items())
                # # print(time_dimensions.items())
